...
from org.bmirdatahub.model.Server import Server
from org.bmirdatahub.model.ServerStatus import ServerStatus
from org.bmirdatahub.model.ServerStatusReport import ServerStatusReport
from org.bmirdatahub.model.ServerTag import ServerTag
...
class ServerWorker(Worker):
    ...
    def status():
        ...
        table = Table("Server", "Status", "Port", 'Error', title=APP_NAME + " Server status list")
