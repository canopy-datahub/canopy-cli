 ...
 SELECT p.study_id,
   ...
   FROM ((public.study s
     ...
     JOIN ( SELECT crosstab.study_id,
            ...
            crosstab.center,
            crosstab.study_start_date,
            crosstab.study_end_date,
            ...
            crosstab.acknowledgment_statement,
	...
	'::text) crosstab(study_id integer, title text, description text, center text, study_start_date text, study_end_date text, is_multi_center text, multi_center_sites text, pi_name text, estimated_participants text, source text, subject text, types text, institutes_supporting_study text, data_general_types text, acknowledgment_statement text, data_species text, disease_specific_group text, disease_specific_related_conditions text, general_research_group text, grant_number text, health_biomed_group text, "study_DOI" text, study_citation text, has_data_files text, actual_study_size text, release_date text, updated_at text, study_version text, study_population_focus text, topics text, "study_website_url" text, "ct_url" text, "publication_url" text, "foa_number" text, "FOA_URL" text, estimated_participant_range text)) p ON ((s.id = p.study_id)));
