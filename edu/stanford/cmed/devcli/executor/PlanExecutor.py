...
from edu.stanford.cmed.devcli.executor.Executor import Executor
from edu.stanford.cmed.devcli.model.Plan import Plan
from edu.stanford.cmed.devcli.model.PlanTask import PlanTask
from edu.stanford.cmed.devcli.util.CustomJSONEncoder import CustomJSONEncoder
...
class PlanExecutor(Executor):
    ...
    def execute(self, plan: Plan, dry_run: bool, dump_plan: bool):
        ...
        json_path = Util.write_app_specific_file(Util.LAST_PLAN_JSON_FILE, plan_json)
        script_path = Util.write_app_specific_file(Util.LAST_PLAN_SCRIPT_FILE, plan_script)
