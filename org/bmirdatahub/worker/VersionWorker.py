...
from org.bmirdatahub.model.ArtifactEntryReport import ArtifactEntryReport
from org.bmirdatahub.model.ArtifactStatus import ArtifactStatus
...
from org.bmirdatahub.model.VersionReport import VersionReport
from org.bmirdatahub.model.VersionType import VersionType
...
class VersionWorker(Worker):
    ...
    def analyze_pom_recursively(self, repo, root_dir, depth, report: VersionReport):
        ...
        res = self.get_spath(tree, '/x:project/x:properties/x:bmirdatahub.version')
        if len(res) == 1:
